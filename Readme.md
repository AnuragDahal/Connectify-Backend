...
This document provides an overview of the API endpoints for our application, detailing the routes and their respective functions.<br> [Click here to view the swagger docs](https://connectify-lx6i.onrender.com/docs)
